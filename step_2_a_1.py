# -*- coding: utf-8 -*-
"""
Created on Mon Jul  5 02:42:10 2021
...
eeg = mne.io.read_raw_brainvision('C:/Users/User/Desktop/Tasks/#####15-P3119-16 Tir/subxp210/sub-xp210_task-2dNF_run-02_eeg.vhdr', 
                                  preload=True)
eeg.info['bads']=['ECG']
eeg.load_data()
print(eeg.ch_names)
...
eeg.filter(l_freq=None, h_freq=1.0)  # low-pass filter 
